...
if 1:
    ...
    method_obj = Method_CNN_MNIST('convention neural network for MNIST dataset', '')
    ...
    print('MNIST Accuracy: ' + str(metric_scores['accuracy']))
    print('MNIST Precision: ' + str(metric_scores['precision']))
    print('MNIST Recall: ' + str(metric_scores['recall']))
    print('MNIST F1: ' + str(metric_scores['f1']))
    print('************ Finish ************')
    # ------------------------------------------------------
