...
from local_code.stage_5_code.Method_GNN_Citeseer import Method_GNN_Citeseer
...
if 1:
    ...
    method_obj = Method_GNN_Citeseer('graph neural network for citeseer dataset', '')
    ...
    print('CITESEER Accuracy: ' + str(metric_scores['accuracy']))
    print('CITESEER Precision: ' + str(metric_scores['precision']))
    print('CITESEER Recall: ' + str(metric_scores['recall']))
    print('CITESEER F1: ' + str(metric_scores['f1']))
    print('************ Finish ************')
    # ------------------------------------------------------
