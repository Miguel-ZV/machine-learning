...
class Dataset_Loader(dataset):
    ...
    def feature_normalize(self, mx):
        ...
        # Use -1 for features (unlike -0.5 for adjacency)
    ...
    def load(self):
        ...
        for c in range(num_classes):
            ...
            train_slice = class_indices[:train_per_class]
            test_slice = class_indices[train_per_class: train_per_class + test_per_class]
            val_slice = class_indices[train_per_class + test_per_class: train_per_class + test_per_class + val_per_class]

            idx_train.extend(train_slice)
            idx_test.extend(test_slice)
            idx_val.extend(val_slice)
